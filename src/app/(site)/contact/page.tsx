  ...
  return (
    <div className="mx-auto max-w-7xl px-4 pb-20 pt-28 sm:px-6">
      <div className="max-w-2xl">
        ...
        <h1 className="font-display mt-3 text-4xl font-bold tracking-tight text-ink-900 sm:text-5xl">We&apos;re here to help</h1>
        <p className="mt-4 text-ink-500">Questions about courses, timings or the license process? Drop a message — a real human replies within a few hours, or call us directly.</p>
      </div>
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_380px]">
        ...
        <div className="space-y-4">
          <Card className="p-6">
            ...
            <a href="tel:+919000000001" className="mt-2 flex items-center gap-2 text-sm font-semibold text-go-600 hover:underline">
              <Phone className="size-4" /> +91 90000 00001
            </a>
            <a href="https://wa.me/919000000001" target="_blank" rel="noreferrer" className="mt-2 flex items-center gap-2 text-sm font-semibold text-go-600 hover:underline">
              <MessageCircle className="size-4" /> WhatsApp us
            </a>
            <a href="mailto:hello@srimathru.in" className="mt-2 flex items-center gap-2 text-sm font-semibold text-go-600 hover:underline">
          ...
          <Card className="p-6">
            ...
            <div className="mt-3 space-y-2 text-sm">
              <div className="flex items-center justify-between">
                <span className="flex items-center gap-2 text-ink-500"><Clock className="size-4 text-brand-500" /> Mon – Sat</span>
                <span className="font-semibold text-ink-800">6:00 AM – 8:00 PM</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="flex items-center gap-2 text-ink-500"><Clock className="size-4 text-brand-500" /> Sunday</span>
                <span className="font-semibold text-ink-800">7:00 AM – 1:00 PM</span>
              </div>
            </div>
          </Card>
              ...
              <div className="mt-3 space-y-3">
                {data.settings.branches.map((b: ApiData) => (
                  <div key={b.id} className="flex gap-2 text-sm">
                    ...
                    <span className="text-ink-600"><span className="font-semibold text-ink-800">{b.name}:</span> {b.address}</span>
                  </div>
                ))}
              </div>
            </Card>
