    ...
    <section className="bg-paper py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-brand-600">Student Stories</span>
        ...
        <div className="relative mx-auto mt-12 max-w-3xl">
          <Card className="p-8 sm:p-10">
            <Quote className="size-8 text-brand-200" fill="currentColor" />
            <p className="mt-4 text-lg leading-relaxed text-ink-800">{current.comment}</p>
          ...
          {reviews.length > 1 && (
            <div className="mt-6 flex items-center justify-between">
              <button
                ...
                className="rounded-xl border border-ink-200 bg-white p-2.5 text-ink-600 hover:bg-ink-50"
